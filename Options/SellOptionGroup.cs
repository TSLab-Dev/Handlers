...
{
    /// <summary>
    /// \~english Sell many options while position risk is 'small'
    /// \~region Продажа группы опционов до заданного уровня риска
    /// </summary>
    [HandlerCategory(HandlerCategories.OptionsPositions)]
    [HelperName("Sell option group", Language = Constants.En)]
    [HelperName("Продажа группы опционов", Language = Constants.Ru)]
    [HandlerAlwaysKeep]
    [InputsCount(8)]
    ...
    [Description("Продажа группы опционов до заданного уровня риска")]
    [HelperDescription("Sell many options while position risk is 'small'", Constants.En)]
    public class SellOptionGroup : IContextUses, IValuesHandlerWithNumber
    {
