...
namespace TSLab.Script.Handlers.Options
{
    ...
    public class OptionSeriesByNumber2 : IContextUses, IValuesHandlerWithNumber, ICustomListValues
    {
        ...
        public IEnumerable<string> GetValuesForParameter(string paramName)
        {
            if (paramName.Equals(nameof(Expiry), StringComparison.InvariantCultureIgnoreCase) ||
                paramName.Equals("Expiry", StringComparison.InvariantCultureIgnoreCase) ||
