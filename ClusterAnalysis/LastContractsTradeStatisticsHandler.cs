...
namespace TSLab.Script.Handlers
{
    ...
    public sealed class LastContractsTradeStatisticsHandler : BaseTradeStatisticsHandler<ILastContractsTradeStatisticsWithKind>, ILastContractsTradeStatisticsHandler
    {
        ...
        protected override ILastContractsTradeStatisticsWithKind InternalExecute(ISecurity security)
        {
            ...
            var stateId = string.Join(".", descriptionId, security.Interval, security.IsAligned, CombinePricesCount, ContractsCount);
